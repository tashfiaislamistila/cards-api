...
const searchButton = () => {
    ...
    if (isNaN(inputValue) || inputValue == "") {
        //isNaN check number or string /others-true
        ...
        error.innerText = "Dont have enough card more than 52";
        input.value = "";
        main.innerHTML = "";
    }
    else {
...
const cardsDisplay = (cards) => {
    // cards = cards.cards; you can do this task like that =>(data.cards)
    // console.log(cards);
